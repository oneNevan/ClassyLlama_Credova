...
//>>excludeStart('excludeBabel', pragmas.excludeBabel)
    ...
    require.s.contexts._.Module.prototype.init = function (depMaps, factory, errback, options) {
        var newFactory = function() {
            var returnValue = factory.apply(this, arguments);

            if(typeof returnValue === 'object' && returnValue.__esModule === true && returnValue.default !== undefined) {
        ...
        oldInit.call(this, depMaps, typeof factory === 'function' ? newFactory : factory, errback, options);
    };
